...
Embedding failover: local → host-a (10.0.0.2:1234) → MacBook (10.0.0.226:1234)
"""
...
LLM_ENDPOINTS = [
    ...
    os.environ.get("LLM_SECONDARY", "http://10.0.0.2:1234"),
    os.environ.get("LLM_TERTIARY",  "http://10.0.0.226:1234"),
]
...
EMBED_ENDPOINTS = [
    ...
    os.environ.get("EMBED_SECONDARY", "http://10.0.0.2:1234"),
    os.environ.get("EMBED_TERTIARY",  "http://10.0.0.226:1234"),
]
