...
def get_category_map():
    ...
    mapping = {
        ...
        "memory_search_scored": "Memory Operations",
        ...
        "memory_grade": "Memory Operations",
        "memory_feedback_stats": "Memory Operations",
        ...
        "notifications_mark_received": "Agent Registry & Notifications",
...
def generate_markdown(all_tools, counts=None):
    ...
    # Self-declaring provenance: this file is generated, but said so nowhere, so a
    # reader (or a doc-count gate) had no way to tell it apart from hand-written
    # prose and its counts looked like drift. Every other generated doc in the
    # tree carries a line like this.
    md += (
        "> **Generated by** `python bin/gen_mcp_inventory.py` — do not edit by hand; "
        "re-run after any tool-catalog change.\n\n"
    )
    md += (
