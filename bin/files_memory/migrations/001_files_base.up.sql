...
--
-- files_memory phase-1 base schema (file_nodes, ingestion_runs, leaves,
-- FTS5, embeddings, empty fact/promotion scaffolding, memory_links).
-- Generated verbatim from schema.SCHEMA_V1 (no hand-transcription).
--
