...
> - 📖 **Auto-generated wiki** — `m3 wiki generate` compiles your canonical memories (pinned, high-confidence, beliefs, procedures) and indexed files into a browsable, interlinked Markdown vault — one page per topic, `[[wikilinks]]` for every relationship, and provenance links down to the source document each fact came from. Open it in Obsidian and the graph view comes free. (See [Wiki Guide](docs/WIKI.md))
