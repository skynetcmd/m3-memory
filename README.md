...
M3 Memory scores **89.0% on [LongMemEval-S](https://github.com/xiaowu0162/LongMemEval)** (445/500 correct) — a 500-question evaluation of long-horizon conversational memory across six question types including single-session recall, multi-session reasoning, temporal reasoning, and knowledge updates. Without oracle metadata: **74.8%** (smart retrieval) to **68.0%** (fixed-k baseline).
...
Full methodology, reproduction command, ablations, and honest caveats: [`benchmarks/longmemeval/README.md`](./benchmarks/longmemeval/README.md).
