...
SCANNERS = [
    ...
    # Quality Scanners (Lint & Static Analysis) - Target Core Directories
    ('ruff',      ['ruff', 'check', '--format', 'sarif', '--output-file', '{out}/ruff.sarif', '{repo}/bin', '{repo}/memory', '{repo}/m3_memory'], 'ruff.sarif', 'SARIF'),
    ('mypy',      ['mypy', '{repo}/bin', '{repo}/memory', '{repo}/m3_memory', '--ignore-missing-imports', '--explicit-package-bases'], 'mypy.txt', None),
]
