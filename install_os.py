...
def setup_oxidation():
    ...
    print("  - Packed MMR rerank: up to ~846x at a realistic candidate pool.")
    print("  - Packed batch-cosine: ~97-178x.  Chatlog redaction: 11-15x.")
    print("  - FTS compile + token-Jaccard: 1.4-10x.")
