...
|---|---|---|
| **NIST SP 800-53 (FISMA)** | Federal information systems — agency ATO support | [FISMA / 800-53 alignment](M3_Compliance_FISMA.html) |
| **CMMC 2.0 / NIST SP 800-171** | DoD contractors handling CUI — Level 2 controls | [CMMC 2.0 alignment](M3_Compliance_CMMC.html) |
...
- [M3 vs alternatives — sovereign substrates table](M3_Comparison_Table.html) — where M3 fits in the broader sovereign-memory landscape
