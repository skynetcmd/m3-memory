...
| **MCP support** | Native — 74 tools, zero config in Claude Code / Gemini CLI | No native MCP; requires a custom wrapper |
...
| **MCP support** | Native — 74 tools, zero config | Custom SDKs / REST API |
...
| **MCP support** | Native — 74 tools | No |
