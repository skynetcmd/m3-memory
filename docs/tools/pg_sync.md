...
tool: bin/pg_sync.py
sha1: 3594d8c96871
mtime_utc: 2026-09-10T06:20:53.810042+00:00
generated_utc: 2026-09-10T06:22:19.106662+00:00
private: false
---
...
- `sqlite3.connect()  → `db_path`` (line 1527)
- `sqlite3.connect()  → `db_path`` (line 1543)
- `sqlite3.connect()  → `target.db_path`` (line 1479)
